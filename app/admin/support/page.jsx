...
const statusColor = {
  open: "text-[var(--gold-deep)] font-bold",
  in_progress: "text-[var(--emerald)]",
...
export default function AdminSupportPage() {
  ...
  return (
    <AdminGuard>
      <div>
        <h1 className="font-display text-2xl mb-4">تذاكر الدعم</h1>
          ...
          {tickets.map(function (t) {
            return (
              <Link
                ...
                className="card flex justify-between items-center text-sm block"
              >
                <div>
                ...
                <span className={statusColor[t.status]}>{statusAr[t.status]}</span>
              </Link>
            );
          })}
